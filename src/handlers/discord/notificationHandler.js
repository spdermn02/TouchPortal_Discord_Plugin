...
class notificationHandler {
  ...
  async onNotification(data) {
      // When getting DMs, or Tagged in a message.. can give  you details as to where.. so could set up a button to take to channel where tagged technically..
              ...
              let content = data.message.content_parsed.map(item => item.content).join(' ');
              ...
              if (channelType === 'voice') {
                ...
                console.log("TEXT CHANNEL |  Guild: ", guildName,  " Author:", userName, "ID:", userId, "Channel ID:", channelId, "Content:", content)
                ...
                console.log("DIRECT MESSAGE | Author:", userName, "ID:", userId, "Channel ID:", channelId, "Content:", content)
                // DG.Client.selectTextChannel(channelId, {timeout: 5});
              }
  }
}
